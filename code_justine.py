...
Data_cond = pd.read_csv('/Users/krishanbumma/Desktop/Manip09_10/09_10_manip1.csv')
Data_T  =pd.read_csv('/Users/krishanbumma/Desktop/Manip09_10/09_10_manip1_temperature.csv')
Data_h = pd.read_csv('/Users/krishanbumma/Desktop/Manip09_10/09_10_manip1_2fps_cropht_mesureh.csv')
Data_Hmax = pd.read_csv('/Users/krishanbumma/Desktop/Manip09_10/09_10_manip1_2fps_MesureHmax.csv')
...
t_Hmax=Data_Hmax['Slice']/2
Hmax_t=Data_Hmax['Y']/scale
...
y_min = 0
y_max = max(max(h_t_interp), max(h_t_phi_ice))*1.1
